...
import { buildAvailableDataApi } from "./utils/api";

let clickUpData;
let hashmap = {};

export const baView = async (context) => {
  ...
  const baData = await buildAvailableDataApi(my_key, listId, assigneeId);
...
export class buildAvailableView {
